...
\hypersetup{
  ...
  pdfsubject={Fictional thesis-style policy paper}
}
...
\newcommand{\DocNoteEN}{This paper is a fictional policy document written for a fictional universe. It is not affiliated with any real party, campaign, government, referendum, or political organization.}
\newcommand{\DocNoteIS}{Þessi ritgerð er skáldað stefnuskjal fyrir skáldaðan heim. Hún tengist ekki neinum raunverulegum stjórnmálaflokki, kosningabaráttu, ríkisstjórn, þjóðaratkvæðagreiðslu eða stjórnmálasamtökum.}
...
\section*{Fictional Disclaimer}
\addcontentsline{toc}{section}{Fictional Disclaimer}
\DocNoteEN

The argument below uses real public data and real comparative examples, including Alaska, Puerto Rico, Iceland's current European Economic Area position, and United States territorial arrangements. Those examples are used analytically for fictional worldbuilding. They should not be read as a real-world electoral programme or campaign instruction.
...
For a fictional Icelandic case, Alaska supports three arguments:
...
This is the line that must be written into every negotiating instruction: Puerto Rico is not a failure of culture or capacity; it is a warning about constitutional incompletion. Partial belonging is not union. It is limbo with paperwork. If Iceland is to enter the United States in this fictional future, it must not enter as a question to be answered later.
...
These guarantees are valuable precisely because they are not imperial. The United States gains a reliable northern partner whose consent is visible, whose infrastructure is lawful, whose public has voted, and whose strategic alignment cannot be purchased quietly by another power.
...
\begin{itemize}
  \item \textbf{Defense and Arctic access:} the United States guarantees funded infrastructure, clear jurisdiction, environmental obligations, and no coercive acquisition; Iceland guarantees reliable access, strategic denial, domain awareness, and allied interoperability.
